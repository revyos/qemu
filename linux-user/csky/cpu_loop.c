...
void cpu_loop(CPUCSKYState *env)
{
    ...
    for (;;) {
        ...
        default:
            pc = env->pc;
            fprintf(stderr, "qemu: 0x%08x: unhandled CPU \
                exception 0x%x - aborting\n", pc, trapnr);
