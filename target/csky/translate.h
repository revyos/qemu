...
int nommu_get_physical_address(CPUCSKYState *env, hwaddr *physical,
                               int *prot, target_ulong address, int rw);
int mpu_get_physical_address(CPUCSKYState *env, hwaddr *physical,
                             int *prot, target_ulong address, int rw);
#endif
...
#define CSKY_VDSP_GREG_MASK             0x1f
...
/* DSPv3 Macro begin */
/* DSPv3 ISA secondary/third OP MASK and SHIFT */
#define CSKY_VDSP2_SIGN_SHI         4
#define CSKY_VDSP2_SIGN_MASK        0x1
#define CSKY_VDSP2_WIDTH_BIT0       20
#define CSKY_VDSP2_WIDTH_BIT1       25

#define CSKY_VDSP2_REG_MASK         0x1f
#define CSKY_VDSP2_REG_SHI_RX       16
#define CSKY_VDSP2_REG_SHI_RY       21
#define CSKY_VDSP2_REG_SHI_RZ       0
#define CSKY_VDSP2_VREG_MASK        0xf
#define CSKY_VDSP2_VREG_SHI_VRX     16
#define CSKY_VDSP2_VREG_SHI_VRY     21
#define CSKY_VDSP2_VREG_SHI_VRZ     0
#define CSKY_VDSP2_INDEX_SHI        21
#define CSKY_VDSP2_INDEX_MASK       0xf
#define CSKY_VDSP2_IMM_SHI          0xf
#define CSKY_VDSP2_IMM_MASK         0x1f
#define CSKY_VDSP2_N_SHI            0x6
#define CSKY_VDSP2_N_MASK           0x3

#define VDSP2_HELPER(name) HELPER(glue(vdsp2_, name))
