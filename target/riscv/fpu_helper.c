                           ...
                           uint64_t rs3, int flags)
{
    if (env->bf16) {
        ...
        bfloat16 frs3 = check_nanbox_bh(rs3);
        return nanbox_h(bfloat16_muladd(frs1, frs2, frs3, flags,
                                        &env->fp_status));
    } else {
...
uint64_t helper_fadd_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        bfloat16 frs2 = check_nanbox_bh(rs2);
        return nanbox_h(bfloat16_add(frs1, frs2, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
        float16 frs2 = check_nanbox_h(rs2);
...
uint64_t helper_fsub_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        bfloat16 frs2 = check_nanbox_bh(rs2);
        return nanbox_h(bfloat16_sub(frs1, frs2, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
        float16 frs2 = check_nanbox_h(rs2);
...
uint64_t helper_fmul_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        bfloat16 frs2 = check_nanbox_bh(rs2);
        return nanbox_h(bfloat16_mul(frs1, frs2, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
        float16 frs2 = check_nanbox_h(rs2);
...
uint64_t helper_fdiv_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        bfloat16 frs2 = check_nanbox_bh(rs2);
        return nanbox_h(bfloat16_div(frs1, frs2, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
        float16 frs2 = check_nanbox_h(rs2);
...
uint64_t helper_fmin_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        bfloat16 frs2 = check_nanbox_bh(rs2);
        return nanbox_h(bfloat16_minnum(frs1, frs2, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
        float16 frs2 = check_nanbox_h(rs2);
        return nanbox_h(float16_minnum(frs1, frs2, &env->fp_status));
    }
}
...
uint64_t helper_fmax_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    ...
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        bfloat16 frs2 = check_nanbox_bh(rs2);
        return nanbox_h(bfloat16_maxnum(frs1, frs2, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
        float16 frs2 = check_nanbox_h(rs2);
        return nanbox_h(float16_maxnum(frs1, frs2, &env->fp_status));
    }
}
...
uint64_t helper_fsqrt_h(CPURISCVState *env, uint64_t rs1)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        return nanbox_h(bfloat16_sqrt(frs1, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
...
target_ulong helper_fle_h(CPURISCVState *env, uint64_t rs1, uint64_t rs2)
{
    ...
    return (r == float_relation_less) || (r == float_relation_equal);
}
...
{
    if (env->bf16) {
        return nanbox_h(int32_to_bfloat16((int32_t)rs1, &env->fp_status));
    } else {
...
{
    if (env->bf16) {
        return nanbox_h(uint32_to_bfloat16((uint32_t)rs1, &env->fp_status));
    } else {
...
{
    if (env->bf16) {
        return nanbox_h(int64_to_bfloat16(rs1, &env->fp_status));
    } else {
...
{
    if (env->bf16) {
        return nanbox_h(uint64_to_bfloat16(rs1, &env->fp_status));
    } else {
...
uint64_t helper_fcvt_s_h(CPURISCVState *env, uint64_t rs1)
{
    if (env->bf16) {
        bfloat16 frs1 = check_nanbox_bh(rs1);
        return nanbox_s(bfloat16_to_float32(frs1, &env->fp_status));
    } else {
        float16 frs1 = check_nanbox_h(rs1);
...
uint64_t helper_fcvt_h_s(CPURISCVState *env, uint64_t rs1)
{
    float32 frs1 = check_nanbox_s(rs1);
    if (env->bf16) {
        return nanbox_h(float32_to_bfloat16(frs1, &env->fp_status));
    } else {
...
{
    if (env->bf16) {
        return nanbox_h(float64_to_bfloat16(rs1, &env->fp_status));
    } else {
        return nanbox_h(float64_to_float16(rs1, true, &env->fp_status));
    }
}

target_ulong helper_fclass_bh(uint64_t rs1)
{
    bfloat16 frs1 = check_nanbox_bh(rs1);
