                                   ...
                                   target_ulong *val)
{
    ...
    if (env->vext_ver == VEXT_VERSION_0_07_1) {
        if (env->mstatus & MSTATUS_VS_V0P7) {
                                    ...
                                    target_ulong val)
{
    ...
    } else if (env->vext_ver == VEXT_VERSION_1_00_0) {
        mask |= MSTATUS_VS;
    }
...
/* T-HEAD priviledged CSR callbacks */
#if !defined(CONFIG_USER_ONLY)
