                            ...
                            target_ulong olen)
{
    ...
    if ((sew > cpu->cfg.elen)
        ...
        /* only set vill bit. */
        if (olen < TARGET_LONG_BITS) {
            env->vtype = (int32_t)FIELD_DP64(0, VTYPE, VILL_OLEN32, 1);
        } else {
                 ...
                 uint32_t esz, uintptr_t ra, MMUAccessType access_type)
{
    ...
    for (i = env->vstart; i < env->vl; i++) {
        ...
        probe_pages(env, base + stride * i, nf << esz, ra, access_type, olen);
    }
    /* do real access */
    for (i = env->vstart; i < env->vl; i++) {
        k = 0;
        ...
        while (k < nf) {
            ...
            ldst_elem(env, adjust_addr(olen, addr), i + k * max_elems, vd, ra);
            k++;
        }
        env->vstart = i;
    }
             ...
             uintptr_t ra, MMUAccessType access_type)
{
    ...
    /* probe every access */
    probe_pages(env, base, evl * (nf << esz), ra, access_type, olen);
          ...
          uint32_t esz, uintptr_t ra)
{
    ...
    for (i = env->vstart; i < env->vl; i++) {
        ...
        addr = adjust_addr(olen, base + i * (nf << esz));
        if (i == 0) {
            probe_pages(env, addr, nf << esz, ra, MMU_DATA_LOAD, olen);
        } else {
                ...
                MMUAccessType access_type)
{
    ...
    /* probe every access */
    probe_pages(env, base, max_elems * nf, ra, access_type, olen);
    ...
    if (off) {
        ...
        for (pos = off; pos < max_elems; pos++) {
            ...
            ldst_elem(env, adjust_addr(olen, addr), pos + k * max_elems, vd, ra);
            env->vstart++;
        }
        k++;
    }
...
GEN_VEXT_VV_ENV(vfadd_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfsub_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfwadd_vv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfwsub_vv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfwadd_wv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfwsub_wv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfmul_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfdiv_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfwmul_vv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfmacc_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfnmacc_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfmsac_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfnmsac_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfmadd_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfnmadd_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfmsub_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfnmsub_vv_bh, 2, 2)
...
GEN_VEXT_VV_ENV(vfwmacc_vv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfwnmacc_vv_bh, 2, 4)
...
GEN_VEXT_VF(vfwnmacc_vf_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfwmsac_vv_bh, 2, 4)
...
GEN_VEXT_VV_ENV(vfwnmsac_vv_bh, 2, 4)
...
GEN_VEXT_VF(vfwnmsac_vf_bh, 2, 4)
...
GEN_VEXT_V_ENV(vfsqrt_v_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfrsqrt7_v_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfrec7_v_bh, 2, 2)
GEN_VEXT_V_ENV(vfrec7_v_h, 2, 2)
GEN_VEXT_V_ENV(vfrec7_v_w, 4, 4)
GEN_VEXT_V_ENV(vfrec7_v_d, 8, 8)

/* Vector Floating-Point MIN/MAX Instructions */
RVVCALL(OPFVV2, vfmin_vv_bh, OP_UUU_H, H2, H2, H2, bfloat16_minnum_noprop)
...
GEN_VEXT_VV_ENV(vfmin_vv_bh, 2, 2)
GEN_VEXT_VV_ENV(vfmin_vv_h, 2, 2)
GEN_VEXT_VV_ENV(vfmin_vv_w, 4, 4)
GEN_VEXT_VV_ENV(vfmin_vv_d, 8, 8)
RVVCALL(OPFVF2, vfmin_vf_bh, OP_UUU_H, H2, H2, bfloat16_minnum_noprop)
...
GEN_VEXT_VF(vfmin_vf_bh, 2, 2)
GEN_VEXT_VF(vfmin_vf_h, 2, 2)
GEN_VEXT_VF(vfmin_vf_w, 4, 4)
GEN_VEXT_VF(vfmin_vf_d, 8, 8)

RVVCALL(OPFVV2, vfmax_vv_bh, OP_UUU_H, H2, H2, H2, bfloat16_maxnum_noprop)
...
GEN_VEXT_VV_ENV(vfmax_vv_bh, 2, 2)
GEN_VEXT_VV_ENV(vfmax_vv_h, 2, 2)
GEN_VEXT_VV_ENV(vfmax_vv_w, 4, 4)
GEN_VEXT_VV_ENV(vfmax_vv_d, 8, 8)
RVVCALL(OPFVF2, vfmax_vf_bh, OP_UUU_H, H2, H2, bfloat16_maxnum_noprop)
...
GEN_VEXT_V_ENV(vfcvt_xu_f_v_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfcvt_x_f_v_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfcvt_f_xu_v_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfcvt_f_x_v_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfwcvt_xu_f_v_bh, 2, 4)
...
GEN_VEXT_V_ENV(vfwcvt_x_f_v_bh, 2, 4)
...
GEN_VEXT_V_ENV(vfwcvt_f_xu_v_bb, 1, 2)
...
GEN_VEXT_V_ENV(vfwcvt_f_x_v_bb, 1, 2)
...
GEN_VEXT_V_ENV(vfwcvt_f_f_v_bh, 2, 4)
...
GEN_VEXT_V_ENV(vfncvt_xu_f_w_bb, 1, 1)
...
GEN_VEXT_V_ENV(vfncvt_x_f_w_bb, 1, 1)
...
GEN_VEXT_V_ENV(vfncvt_f_xu_w_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfncvt_f_x_w_bh, 2, 2)
...
GEN_VEXT_V_ENV(vfncvt_f_f_w_bh, 2, 2)
...
/* Unordered sum */
GEN_VEXT_FRED(vfredsum_vs_bh, uint16_t, uint16_t, H2, H2, bfloat16_add)
...
/* Maximum value */
GEN_VEXT_FRED(vfredmax_vs_bh, uint16_t, uint16_t, H2, H2, bfloat16_maxnum_noprop)
...
/* Minimum value */
GEN_VEXT_FRED(vfredmin_vs_bh, uint16_t, uint16_t, H2, H2, bfloat16_minnum_noprop)
...
void HELPER(vfwredsum_vs_bh)(void *vd, void *v0, void *vs1,
                             void *vs2, CPURISCVState *env, uint32_t desc)
{
    uint32_t vm = vext_vm(desc);
    uint32_t vl = env->vl;
