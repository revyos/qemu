...
struct rvv_reg dst_vl[] = {
    ...
    {
        .fixs32 = {
            {0xcfe06686, 0x8262f665, 0x15fc5229, 0xd6b97466, },
...
struct rvv_reg dst_odd[] = {
    ...
    {
        .fixs32 = {
            {0xcfe06686, 0x8262f665, 0x15fc5221, 0xd6b97466, },
            {0xcfe06686, 0x8262f675, 0x15fc5221, 0xd6b97476, },
        },
    },
    /* result */
    {
...
int main(void)
{
    init_testsuite("Testing insn vamoaddw\n");

    /* sew 32 */
    test_vamoaddw_32(vlmax_32 - 1, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst_vl[2].fixs32[0]);
    result_compare_s32_lmul(src0[0].fixs32[0], dst_vl[0].fixs32[0]);
    restore_src();
    test_vamoaddw_32_vm(&vme.fixs32, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst_even[1].fixs32[0]);
    result_compare_s32_lmul(src0[0].fixs32[0], dst_even[0].fixs32[0]);

    restore_src();
    test_vamoaddw_32_vm(&vmo.fixs32, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst_odd[1].fixs32[0]);
    result_compare_s32_lmul(src0[0].fixs32[0], dst_odd[0].fixs32[0]);

    restore_src();
    /* sew 64 */
    test_vamoaddw_64(vlmax_64 - 1, &pad.fixs64[0], src0[0].fixs32[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_vl[2].fixs64[0]);
    result_compare_s32(src0[0].fixs32[0], dst_vl[1].fixs32[0]);

    restore_src();
    test_vamoaddw_64_vm(&vme.fixs64, &pad.fixs64[0], src0[0].fixs32[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_even[1].fixs64[0]);
    result_compare_s32(src0[0].fixs32[0], dst_even[0].fixs32[0]);

    restore_src();
    test_vamoaddw_64_vm(&vmo.fixs64, &pad.fixs64[0], src0[0].fixs32[0], src1[0].fixs64[0], res0.fixs64[0]);
