...
int main(void)
{
    init_testsuite("Testing insn vamomind\n");

    /* sew 64 */
    test_vamomind_64(vlmax_64 - 1, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_vl[1].fixs64[0]);
    result_compare_s64_lmul(src0[0].fixs64[0], dst_vl[0].fixs64[0]);

    restore_src();
    test_vamomind_64_vm(&vme.fixs64, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_even[1].fixs64[0]);
    result_compare_s64_lmul(src0[0].fixs64[0], dst_even[0].fixs64[0]);

    restore_src();
    test_vamomind_64_vm(&vmo.fixs64, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
