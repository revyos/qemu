...
struct rvv_reg dst_vl[] = {
    ...
    {
        .fixs32 = {
            {0x00000000, 0x00000004, 0x15fc5221, 0x0000000c, },
            {0x00000010, 0x00000014, 0x15fc5221, 0xd6b9745a, },
        },
    },
    {
        .fixs32 = {
            {0x00000000, 0x00000004, 0x15fc5221, 0xd6b9745a, },
...
struct rvv_reg dst_even[] = {
    ...
    {
        .fixs32 = {
            {0x00000000, 0x8262f661, 0x15fc5221, 0xd6b9745a, },
            {0x00000010, 0x8262f661, 0x15fc5221, 0xd6b9745a, },
        },
    },
    /* result */
    {
...
int main(void)
{
    init_testsuite("Testing insn vamomaxw\n");

    /* sew 32 */
    test_vamomaxw_32(vlmax_32 - 1, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst_vl[2].fixs32[0]);
    result_compare_s32_lmul(src0[0].fixs32[0], dst_vl[0].fixs32[0]);
    restore_src();
    test_vamomaxw_32_vm(&vme.fixs32, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst_even[1].fixs32[0]);
    result_compare_s32_lmul(src0[0].fixs32[0], dst_even[0].fixs32[0]);

    restore_src();
    test_vamomaxw_32_vm(&vmo.fixs32, &pad.fixs32[0], src0[0].fixs32[0], src1[0].fixs32[0], res0.fixs32[0]);
    result_compare_s32_lmul(res0.fixs32[0], dst_odd[1].fixs32[0]);
    result_compare_s32_lmul(src0[0].fixs32[0], dst_odd[0].fixs32[0]);

    restore_src();
    /* sew 64 */
    test_vamomaxw_64(vlmax_64 - 1, &pad.fixs64[0], src0[0].fixs32[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_vl[2].fixs64[0]);
    result_compare_s32(src0[0].fixs32[0], dst_vl[1].fixs32[0]);

    restore_src();
    test_vamomaxw_64_vm(&vme.fixs64, &pad.fixs64[0], src0[0].fixs32[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_even[1].fixs64[0]);
    result_compare_s32(src0[0].fixs32[0], dst_even[0].fixs32[0]);

    restore_src();
    test_vamomaxw_64_vm(&vmo.fixs64, &pad.fixs64[0], src0[0].fixs32[0], src1[0].fixs64[0], res0.fixs64[0]);
