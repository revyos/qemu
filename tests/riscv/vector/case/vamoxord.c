...
struct rvv_reg dst_odd[] = {
    /* src0 */
    {
        .fixs64 = {
            {0xffffffffcfe06686, 0xffffffff8262f669, },
            {0x0000000015fc5221, 0xffffffffd6b97442, },
        },
...
int main(void)
{
    init_testsuite("Testing insn vamoxord\n");

    /* sew 64 */
    test_vamoxord_64(vlmax_64 - 1, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_vl[1].fixs64[0]);
    result_compare_s64_lmul(src0[0].fixs64[0], dst_vl[0].fixs64[0]);

    restore_src();
    test_vamoxord_64_vm(&vme.fixs64, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
    result_compare_s64_lmul(res0.fixs64[0], dst_even[1].fixs64[0]);
    result_compare_s64_lmul(src0[0].fixs64[0], dst_even[0].fixs64[0]);

    restore_src();
    test_vamoxord_64_vm(&vmo.fixs64, &pad.fixs64[0], src0[0].fixs64[0], src1[0].fixs64[0], res0.fixs64[0]);
