...
struct rvv_reg dst_rnu[] = {
    {
        .fixs64 = {
            {0x8000000000000000, 0xdfc6e7a8b0f6a7b6,},
            {0x18cf500358088d2e, 0x0000000000000000,},
        },
        .fixs32 = {
            {0x80000000, 0xc851a526, 0xd70c4f51, 0xe1ed1aef,},
            {0xac25c8a3, 0xc851a526, 0xd70c4f51, 0x00000000,},
        },
        .fixs16 = {
            {0x8000, 0x0c20, 0xd4d6, 0x0a05, 0xea64, 0x59e1, 0x0ba1, 0xe8d8,},
            {0xc38f, 0x0c20, 0xd4d6, 0x0a05, 0xea64, 0x59e1, 0x0ba1, 0x0000,},
        },
        .fixs8 = {
            {0x80, 0x3f, 0x00, 0x1d, 0xf6, 0x36, 0x01, 0x33, 0x1a, 0x03, 0x48, 0x06, 0xeb, 0xef, 0xea, 0x33,},
