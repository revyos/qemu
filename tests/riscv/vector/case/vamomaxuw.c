...
int main(void)
{
    init_testsuite("Testing insn vamomaxuw\n");

    /* sew 32 */
    test_vamomaxuw_32(vlmax_32 - 1, &pad.fixu32[0], src0[0].fixu32[0], src1[0].fixu32[0], res0.fixu32[0]);
    result_compare_u32_lmul(res0.fixu32[0], dst_vl[2].fixu32[0]);
    result_compare_u32_lmul(src0[0].fixu32[0], dst_vl[0].fixu32[0]);
    restore_src();
    test_vamomaxuw_32_vm(&vme.fixu32, &pad.fixu32[0], src0[0].fixu32[0], src1[0].fixu32[0], res0.fixu32[0]);
    result_compare_u32_lmul(res0.fixu32[0], dst_even[1].fixu32[0]);
    result_compare_u32_lmul(src0[0].fixu32[0], dst_even[0].fixu32[0]);

    restore_src();
    test_vamomaxuw_32_vm(&vmo.fixu32, &pad.fixu32[0], src0[0].fixu32[0], src1[0].fixu32[0], res0.fixu32[0]);
    result_compare_u32_lmul(res0.fixu32[0], dst_odd[1].fixu32[0]);
    result_compare_u32_lmul(src0[0].fixu32[0], dst_odd[0].fixu32[0]);

    restore_src();
    /* sew 64 */
    test_vamomaxuw_64(vlmax_64 - 1, &pad.fixu64[0], src0[0].fixu32[0], src1[0].fixu64[0], res0.fixu64[0]);
    result_compare_u64_lmul(res0.fixu64[0], dst_vl[2].fixu64[0]);
    result_compare_u32(src0[0].fixu32[0], dst_vl[1].fixu32[0]);

    restore_src();
    test_vamomaxuw_64_vm(&vme.fixu64, &pad.fixu64[0], src0[0].fixu32[0], src1[0].fixu64[0], res0.fixu64[0]);
    result_compare_u64_lmul(res0.fixu64[0], dst_even[1].fixu64[0]);
    result_compare_u32(src0[0].fixu32[0], dst_even[0].fixu32[0]);

    restore_src();
    test_vamomaxuw_64_vm(&vmo.fixu64, &pad.fixu64[0], src0[0].fixu32[0], src1[0].fixu64[0], res0.fixu64[0]);
