...
int main(void)
{
    init_testsuite("Testing insn vamomaxud\n");

    /* sew 64 */
    test_vamomaxud_64(vlmax_64 - 1, &pad.fixu64[0], src0[0].fixu64[0], src1[0].fixu64[0], res0.fixu64[0]);
    result_compare_u64_lmul(res0.fixu64[0], dst_vl[1].fixu64[0]);
    result_compare_u64_lmul(src0[0].fixu64[0], dst_vl[0].fixu64[0]);

    restore_src();
    test_vamomaxud_64_vm(&vme.fixu64, &pad.fixu64[0], src0[0].fixu64[0], src1[0].fixu64[0], res0.fixu64[0]);
    result_compare_u64_lmul(res0.fixu64[0], dst_even[1].fixu64[0]);
    result_compare_u64_lmul(src0[0].fixu64[0], dst_even[0].fixu64[0]);

    restore_src();
    test_vamomaxud_64_vm(&vmo.fixu64, &pad.fixu64[0], src0[0].fixu64[0], src1[0].fixu64[0], res0.fixu64[0]);
