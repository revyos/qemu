...
struct matrix_mmaqa_b dst0[] = {
    {
        .matrix_int32_s4x4 = {
                {0x00000811, 0x00000011, 0x00000021, 0x00001001},
                {0x0007F811, 0x00000011, 0x00001001, 0x000FE021},
                {0x00040011, 0x00000011, 0x00000811, 0x0007F811},
                {0x00000011, 0x00000011, 0x00000011, 0x00000011},
            },
    },{
        .matrix_int32_s4x4 = {
                {0x00000411, 0x00000011, 0x00000019, 0x00000000},
                {0x0003FC11, 0x00000011, 0x00000809, 0x00000000},
...
int main(void)
{
    init_testsuite("Testing insn mmaqau.b\n");

    test_mmaqau_4x4(src0[0].matrix_uint8_s4x16,
                    src1[0].matrix_uint8_s4x16,
    ...
    test_mmaqau_2x3(src0[0].matrix_uint8_s4x16,
                   src1[0].matrix_uint8_s4x16,
                   src2[0].matrix_int32_s4x4,
                   res.matrix_int32_s4x4);
