...
struct matrix_pmmaqa_b dst0[] = {
    {
        .matrix_int32_s4x4 = {
                ...
                {0x00000391, 0x000014B1, 0x00000101, 0x00001131},
                {0x00000411, 0x00000791, 0x00000011, 0x00000391},
                {0x00000791, 0x00001C31, 0x00000101, 0x000014B1},
        },
    },{
        .matrix_int32_s4x4 = {

                {0x00000011, 0x00000089, 0x00000019, 0x00000000},
                {0x000001D1, 0x00000A61, 0x00000089, 0x00000000},
...
{
    int i = 0;
    init_testsuite("Testing insn pmmaqau.b\n");

    test_pmmaqau_4x4(src0[0].matrix_uint4_s4x32,
    ...
    test_pmmaqau_2x3(src0[0].matrix_uint4_s4x32,
                     src1[0].matrix_uint4_s4x32,
                     src2[0].matrix_int32_s4x4,
                     res.matrix_int32_s4x4);
