...
struct matrix_pmmaqa_b dst0[] = {
    {
        .matrix_int32_s4x4 = {
                ...
                {0x00000011, 0x00000391, 0xFFFFFC11, 0xFFFFFF91},
                {0x00000101, 0x000005B1, 0xFFFFF891, 0xFFFFFE31},
                {0x00000021, 0x00000001, 0x00000011, 0x00000001},
                {0x00000101, 0x00000231, 0xFFFFFC91, 0xFFFFFEB1},
        },
    },{
        .matrix_int32_s4x4 = {

                {0x00000011, 0x000001D1, 0xFFFFFE11, 0x00000000},
                {0x00000089, 0x000002E1, 0xFFFFFC51, 0x00000000},
...
{
    int i = 0;
    init_testsuite("Testing insn pmmaqaus.b\n");

    test_pmmaqaus_4x4(src0[0].matrix_uint4_s4x32,
    ...
    test_pmmaqaus_2x3(src0[0].matrix_uint4_s4x32,
                      src1[0].matrix_int4_s4x32,
                      src2[0].matrix_int32_s4x4,
                      res.matrix_int32_s4x4);
