...
struct matrix_mmaqa_h src2[] = {
    {
        .mat_int64_s4x2_pair = {
                {{0x0000000000000000, 0x0000000000000000},
                 ...
                 {0x0000000000000808, 0x0000000000000003}},
...
struct matrix_mmaqa_h dst0[] = {
    {
        .mat_int64_s4x2_pair = {
                ...
                {0x0000000000000001, 0x0000000000000001},
                {0xFFFFFFFFFFFFFFFA, 0x0000000000000002},
...
{
    int i = 0;
    init_testsuite("Testing insn mmaqaus.h\n");

    test_mmaqaus_full_h128(src0[i].matrix_uint16_s4x8,
