...
struct matrix_ld_st src0[] = {
    {
        ...
        .move_int64 = {
                {0x0000000011111111, 0x8000000000000000, 0x00FFFFFFFfffffff, 0xFFFFFFFFFfffffff},
                {0x0000000000000001, 0x7000000000000000, 0x0fffffffffffffff, 0x000000000fffffff},
                {0x0000000000000000, 0x7FFFFFFFFFFFFFFF, 0xFFFFFFFFFfffffff, 0xffffffffffffffff},
        },
    }
};
