...
struct matrix_mn4clip_s dst0[] = {
    {
        .matrix_uint8_4x16 = {{0x10, 0x12, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                              {0x10, 0x12, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                              {0x10, 0x12, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                              {0x10, 0x12, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},}
    },
    {
        .matrix_uint8_4x16 = {{0x10, 0x12, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                              {0x10, 0x12, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                              {0x10, 0x12, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
int main(void)
{
    init_testsuite("Testing insn mn4clipu.s.mx\n");

    test_mn4clipu_s_mx(src0[0].matrix_uint32_4x4,
    ...
    test_mn4clipu_s_mx_3x3(src0[0].matrix_uint32_4x4,
                           src1[0].matrix_uint32_4x4,
                           res.matrix_uint8_4x16,
                           12);
