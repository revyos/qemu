...
struct matrix_mmaqa_b dst0[] = {
    {
        .matrix_int32_s4x4 = {
            {0x00000001, 0xFFFFF811, 0xFFFFF021, 0x00000011},
            {0x00000011, 0x00000011, 0x00000011, 0x00000011},
            {0X00000021, 0X00000811, 0X00001001, 0X00000011},
            {0XFFFFF811, 0XFFFC0011, 0XFFF80811, 0X00000011},
        },
    },
    {
        .matrix_int32_s4x4 = {
            {0x00000009, 0xFFFFFC11, 0xFFFFF819, 0x00000000},
...
int main(void)
{
    init_testsuite("Testing insn mmaqasu.b\n");

    test_mmaqasu_4x4(src0[0].matrix_int8_s4x16,
    ...
    test_mmaqasu_2x3(src0[0].matrix_int8_s4x16,
                     src1[0].matrix_uint8_s4x16,
                     src2[0].matrix_int32_s4x4,
                     res.matrix_int32_s4x4);
