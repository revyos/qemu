...
int main(void)
{
    init_testsuite("Testing insn vpmaqau.vx\n");

    /* vpmaqau.vx */
    test_vpmaqau_vx(src0[0].fixu8[0], src1, res.fixs32[0], &vma8, pad.fixs32[0]);
    result_compare_s32(res.fixs32[0], dst_vl[0].fixs32[0]);

    test_vpmaqau_vx(src0[0].fixu8[0], src1, res.fixs32[0], &vme8, pad.fixs32[0]);
    result_compare_s32(res.fixs32[0], dst_even[0].fixs32[0]);

    test_vpmaqau_vx(src0[0].fixu8[0], src1, res.fixs32[0], &vmo8, pad.fixs32[0]);
