...
int main(void)
{
    init_testsuite("Testing insn vpmaqa.vx\n");

    /* vpmaqa.vx */
    test_vpmaqa_vx(src0[0].fixs8[0], src1, res.fixs32[0], &vma8, pad.fixs32[0]);
    result_compare_s32(res.fixs32[0], dst_vl[0].fixs32[0]);

    test_vpmaqa_vx(src0[0].fixs8[0], src1, res.fixs32[0], &vme8, pad.fixs32[0]);
    result_compare_s32(res.fixs32[0], dst_even[0].fixs32[0]);

    test_vpmaqa_vx(src0[0].fixs8[0], src1, res.fixs32[0], &vmo8, pad.fixs32[0]);
