/*
 * T-HEAD nand flash controller emulation.
 *
...
#define TYPE_THEAD_NAND  "csky_nand"
#define THEAD_NAND(obj)  OBJECT_CHECK(csky_nand_state, (obj), TYPE_THEAD_NAND)
...
static void csky_nand_init(Object *obj)
{
    csky_nand_state *s = THEAD_NAND(obj);
...
static const TypeInfo onenand_info = {
    .name          = TYPE_THEAD_NAND,
    .parent        = TYPE_SYS_BUS_DEVICE,
    .instance_size = sizeof(csky_nand_state),
    .instance_init = csky_nand_init,
