...
#define TYPE_THEAD_UART  "csky_uart_dummy"
#define THEAD_UART(obj)  OBJECT_CHECK(csky_uart_dummy_state, (obj), TYPE_THEAD_UART)
...
static void csky_uart_dummy_event(void *opaque, QEMUChrEvent event)
{
}
...
{
    csky_uart_dummy_state *s = THEAD_UART(obj);
...
{
    csky_uart_dummy_state *s = THEAD_UART(dev);
...
static void csky_uart_dummy_class_init(ObjectClass *oc, void *data)
{
    ...
    dc->props_ = csky_uart_dummy_properties;
