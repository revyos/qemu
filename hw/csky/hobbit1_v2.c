/*
 * CSKY Hobbit1-2 System emulation.
 *
...
static void hobbit1_2_init(MachineState *machine)
{
    ...
    memory_region_init_ram(ram0, NULL, "hobbit1_2.sdram0",
                           HOBBIT1_2_SRAM0, &error_fatal);
    memory_region_add_subregion(sysmem, 0x0, ram0);
    memory_region_init_ram(ram1, NULL, "hobbit1_2.sdram1",
                           HOBBIT1_2_SRAM1, &error_fatal);
    memory_region_add_subregion(sysmem, 0x10000000, ram1);
    memory_region_init_ram(ram2, NULL, "hobbit1_2.sdram2",
                           HOBBIT1_2_SRAM2, &error_fatal);
