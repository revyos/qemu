...
#define TYPE_THEAD_LCDC  "csky_lcdc"
#define THEAD_LCDC(obj)  OBJECT_CHECK(csky_lcdc_state, (obj), TYPE_THEAD_LCDC)
...
{
    csky_lcdc_state *s = THEAD_LCDC(d);
