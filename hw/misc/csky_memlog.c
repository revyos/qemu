...
#define TYPE_THEAD_MEMLOG  "csky_memlog"
#define THEAD_MEMLOG(obj)  OBJECT_CHECK(csky_memlog_state, (obj), \
                                       TYPE_THEAD_MEMLOG)
