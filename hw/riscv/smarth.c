...
static void smarth_init(MachineState *machine)
{
    ...
    riscv_aclint_swi_create(0x4004000000, 0, smp_cpus, false);
    riscv_aclint_swi_create(0x400400C000, 0, smp_cpus, true);
    ...
    riscv_aclint_mtimer_create(0x400400D000, RISCV_ACLINT_DEFAULT_MTIMER_SIZE,
                               0, smp_cpus, RISCV_ACLINT_DEFAULT_MTIMECMP,
