...
#define TYPE_THEAD_DMA   "csky_dma"
#define THEAD_DMA(obj)   OBJECT_CHECK(csky_dma_state, (obj), TYPE_THEAD_DMA)
...
static const VMStateDescription vmstate_csky_dma_channel = {
    ...
    .fields = (VMStateField[]) {
        VMSTATE_UINT64(src, csky_dma_channel),
        VMSTATE_UINT64(dest, csky_dma_channel),
...
static const VMStateDescription vmstate_csky_dma = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_STRUCT_POINTER(chan, csky_dma_state,
                               vmstate_csky_dma_channel, csky_dma_channel),
        VMSTATE_END_OF_LIST()
    }
};
...
static void csky_dma_init(Object *obj)
{
    ...
    csky_dma_state *s = THEAD_DMA(obj);
    int i;
