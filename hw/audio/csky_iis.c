...
#define TYPE_THEAD_IIS   "csky_iis"
#define THEAD_IIS(obj)   OBJECT_CHECK(csky_iis_state, (obj), TYPE_THEAD_IIS)
 ...
 *     success
 **************************************************************************/
static void csky_iis_init(Object *obj)
{
    SysBusDevice *dev = SYS_BUS_DEVICE(obj);
    csky_iis_state *s = THEAD_IIS(dev);
