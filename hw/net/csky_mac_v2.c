 ...
 *     SUCCESS or FAILURE
 ***************************************************************************/
static void csky_mac_v2_init(Object *obj)
{
    ...
    csky_mac_v2_reset(s);
    s->timer = ptimer_init(csky_mac_v2_timer_tick, s, PTIMER_POLICY_LEGACY);
}
...
static void csky_mac_v2_class_init(ObjectClass *klass, void *data)
{
    ...
    dc->props_ = csky_mac_v2_properties;
...
static const TypeInfo csky_mac_v2_info = {
    ...
    .instance_init = csky_mac_v2_init,
